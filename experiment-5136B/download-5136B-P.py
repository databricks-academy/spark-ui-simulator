...
capture = Capture(working_dir=os.getcwd(),
                  notebook_path="/Repos/student@azuredatabrickstraining.onmicrosoft.com/spark-ui-simulator-experiments/Exp #5136 - Cluster-Attached Drives/Exp #5136B - Cluster-Attached Drives, SSD",
                  headless=True,
                  version="v003-P",
                  languages=["python"],
                  has_lab=True)
