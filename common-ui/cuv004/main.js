...
let clusterDotIds = ["cc-ui","cc-json","cc-cm0","cc-cm1","cc-cm2","cc-gng"];
...
function initCluster() {
    ...
    document.getElementById("cc-gng").setAttribute("href",    "../../experiment-"+experiment+"/"+version+"/screenshots/ganglia-0.png");
